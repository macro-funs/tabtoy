...
func createOutputTable(symbols *model2.TypeTable, inputTab *model2.DataTable) *model2.DataTable {
	outputTab := model2.NewDataTable()
...
func MergeData(inputList, outputList *model2.DataTableList, symbols *model2.TypeTable) {

	for _, inputTab := range inputList.AllTables() {

		var outputTab *model2.DataTable
...
func combineRepeatedCell(outputCell, inputCell *model2.Cell, inputHeader *model2.HeaderField, inputTab *model2.DataTable) {
