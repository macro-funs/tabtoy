...
格式请参考:
	...
	[Sample.xlsx]: (https://github.com/macro-funs/tabkit/blob/master/exportorv2/exsample/Sample.xlsx)
...
* 已经编译好的二进制:
	...
	[Tabtoy Release]: (https://github.com/macro-funs/tabkit/releases)
...
* 范例: 生成cs后, 需要再生成bin格式, 通过[C#读取器]: (https://github.com/macro-funs/tabkit/blob/master/exportorv2/csharp) 读取二进制数据
...
* 范例: 生成bin后, 需要再生成cs格式, 通过[C#读取器]: (https://github.com/macro-funs/tabkit/blob/master/exportorv2/csharp) 读取二进制数据
...
* 范例: https://github.com/macro-funs/tabkit/blob/master/exportorv2/exsample/Vertical.xlsx

# FAQ
问：如何导出结构体数组？
答：参考例子https://github.com/macro-funs/tabkit/blob/master/exportorv2/exsample/Sample.xlsx
中StrStruct字段
...
参考文件夹:
	...
	[范例]: (https://github.com/macro-funs/tabkit/blob/master/exportorv2/exsample)	
